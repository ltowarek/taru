...
def on_message(client, database_link, message):
    ...
    database_link.save(message.topic, message.payload.decode().replace(',', '.'))
...
def run():
    ...
    link.subscribe('inverter/response/grid_voltage', 'grid_voltage', float)
    link.subscribe('inverter/response/grid_frequency', 'grid_frequency', float)
    link.subscribe('inverter/response/ac_output_voltage', 'ac_output_voltage', float)
    link.subscribe('inverter/response/ac_output_frequency', 'ac_output_frequency', float)
    ...
    link.subscribe('inverter/response/battery_voltage', 'battery_voltage', float)
    link.subscribe('inverter/response/battery_charging_current', 'battery_charging_current', int)
    link.subscribe('inverter/response/battery_capacity', 'battery_capacity', percent)
    ...
    link.subscribe('inverter/response/pv_input_voltage', 'pv_input_voltage', float)
    link.subscribe('inverter/response/battery_voltage_from_scc', 'battery_voltage_from_scc', float)
